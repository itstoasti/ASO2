...
import { Search, SlidersHorizontal, LayoutGrid, Table, Swords, Target, Key, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 block sm:hidden bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-t border-slate-200/80 dark:border-slate-800 pb-safe shadow-lg">
      <div className="flex items-center justify-around h-14 px-1">
        ...
        <Link
          href="/"
          className={`flex flex-col items-center justify-center w-12 h-full active:scale-90 transition-transform cursor-pointer ${
        ...
        >
          ...
          <span className="text-[9px] tracking-tight">Tracker</span>
        </Link>
        ...
        <Link
          href="/competitors"
          className={`flex flex-col items-center justify-center w-12 h-full active:scale-90 transition-transform cursor-pointer ${
            activeTab === 'competitors' ? 'text-blue-600 dark:text-blue-400 font-bold' : 'text-slate-500 dark:text-slate-400 font-medium'
          }`}
        >
          <Swords className="w-4 h-4 mb-0.5" />
          <span className="text-[9px] tracking-tight">Competitors</span>
        </Link>
        ...
        <button
          ...
          className="relative flex flex-col items-center justify-center w-12 h-full text-slate-500 dark:text-slate-400 active:scale-90 transition-transform cursor-pointer"
        >
          ...
          <span className="text-[9px] font-medium tracking-tight">Filters</span>
        </button>
        ...
        >
          {asaConfigured ? (
            <ShieldCheck className="w-4 h-4 mb-0.5 text-blue-600 dark:text-blue-400" />
          ) : (
            <Key className="w-4 h-4 mb-0.5" />
          )}
          <span className="text-[9px] font-medium tracking-tight">ASA API</span>
        </button>
      </div>
    </div>
  );
